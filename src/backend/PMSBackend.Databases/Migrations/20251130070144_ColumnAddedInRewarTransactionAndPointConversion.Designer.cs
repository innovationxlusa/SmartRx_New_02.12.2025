...
namespace PMSBackend.Databases.Migrations
{
    ...
    [Migration("20251130070144_ColumnAddedInRewarTransactionAndPointConversion")]
    partial class ColumnAddedInRewarTransactionAndPointConversion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_Reward", b =>
                {
                    ...
                    b.Property<double?>("CashablePoints")
                        .HasColumnType("float");

                    b.Property<double?>("CashedMoney")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("NonCashablePoints")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_RewardBadgeEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int?>("RequiredActivities")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_RewardRuleEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("ActivityTaken")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsVisibleBenifit")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("Configuration_Reward_Rules");
                });

            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_Settings", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("IsRewardNegetivePointAllowed")
                        .HasColumnType("bit");
                    ...
                    b.Property<long>("PresentRewardBadgeId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_UserActivityEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("ActivityPoint")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("Configuration_UserActivity");
                });
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_PatientReward", b =>
                {
                    ...
                    b.Property<bool>("IsDeductPoints")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_RewardPointConversionsEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_RewardTransactionEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("CashableBalance")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CashablePoints")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CashedMoneyBalance")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("NonCashableBalance")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("SmartRx_Reward_Transactions");
                });

            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_Reward_UserBalancesEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("CashedMoney")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("NonCashablePoints")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("SmartRx_Reward_UserBalances");
                });

            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_UserRewardBadgeEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SmartRx_UserRewardBadge");
                });
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_Reward", b =>
                {
                    ...
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_UserActivityEntity", "UserActivity")
                        .WithMany()
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_PatientReward", b =>
                {
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_RewardBadgeEntity", "RewardBadge")
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_RewardTransactionEntity", b =>
                {
                    ...
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_RewardRuleEntity", "RewardRule")
                        .WithMany()
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_UserRewardBadgeEntity", b =>
                {
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_RewardBadgeEntity", "Badge")
                        .WithMany()
                        .HasForeignKey("BadgeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
