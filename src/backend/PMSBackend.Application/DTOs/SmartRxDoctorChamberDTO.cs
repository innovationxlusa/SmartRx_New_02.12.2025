...
{
    public class SmartRxDoctorChamberDTO
    {
        ...
        public string? HospitalLogoFileName { get; set; }
        public string? HospitalLogoFilePath { get; set; }
        public string? HospitalLogoFileExtension { get; set; }
    }
}
